...
class LegacyMediaMixin(LegacyImportedModelMixin):
...
class AbstractDocument(LegacyMediaMixin, WagtailAbstractDocument):
    class Meta(WagtailAbstractDocument.Meta):
        abstract = True


class AbstractImage(LegacyMediaMixin, WagtailAbstractImage):
    class Meta(WagtailAbstractImage.Meta):
        abstract = True
